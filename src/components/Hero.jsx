      ...
      <Carousel.Item interval={1000}>
        <div >
          <Row className='caro1 g-0 p-0 m-0' >
            ...
            <Col xs={12} lg={7}>
              <img className='im' src="https://cdn-dynmedia-1.microsoft.com/is/image/microsoftcorp/Highlight-Slim-Multi-Canvas-M365-Anthem-Attract-Image-Create:VP2-859x540" alt="" />
            </Col>
          </Row>
        </div>
        <Carousel.Caption>
